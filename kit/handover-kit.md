...
- **Two things to send Trevon near the end of Prompt 2:** a short one-word household name you want (like `smith`) and the app address Claude gives you. He adds you to the sign-in directory so your phones can sign in with just the name.
